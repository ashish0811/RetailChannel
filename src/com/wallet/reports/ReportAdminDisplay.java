 ...
 */
@WebServlet("/ReportAdminDisplay")
public class ReportAdminDisplay extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportAdminDisplay() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hiddenType.equals("reportDisp") && (txnType.equalsIgnoreCase("Topup") || txnType.equalsIgnoreCase("Register"))){
			...
			try {
				...
				//reports = dm.dispAdminReports(txnType, toDate, fromDate, partnerId);
			} catch (Exception e) {
